...
/////////////////////////////////////////////////////
	...
	public int getNumberOfMoves(String handInString) throws FreecellBoard.ParseException {
		FreecellBoard hand = FreecellBoard.parse(new ByteArrayInputStream(handInString.getBytes()));
		// solve it
		try {
			freecellSolver.solve(hand);
		...
		return freecellSolver.solvedMove;
	...
	private static void printHelp() {
		System.out.println("FreeCell Java Solver - version " + FreecellSolver.VERSION_STRING);
